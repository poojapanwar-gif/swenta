    ...
    <div className={styles["banner-section"]}>
      <div className={styles["banner-left-right-section"]}>
        <div className={styles["banner-left-section"]}>
          <h6>—UAE CORPORATE TAX SERVICES</h6>
          <h2>Corporate tax support without the uncertainty</h2>
          <h4>
            Get practical support for registration, accurate filing and ongoing UAE tax compliance from experienced professionals.
          </h4>
          <p>
            <svg
              width="12"
            ...
            Corporate tax · VAT support · Filing & advisory
          </p>
