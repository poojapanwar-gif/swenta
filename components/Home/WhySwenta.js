...
const WhySwenta = () => {
  const allList = [
    "Reliable numbers available on a predictable monthly schedule",
    "Lower cost than building an equivalent in-house team",
    "Records kept audit-ready and tax-ready throughout the year",
    "Clear visibility of margins, costs and working capital",
