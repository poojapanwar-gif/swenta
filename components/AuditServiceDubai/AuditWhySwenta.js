...
const AuditWhySwenta = () => {
  const allList = [
    "Shorter, more predictable audit cycles",
    "Fewer findings and cleaner year-on-year outcomes",
    "Stronger controls over the processes that carry the most risk",
    "Documented evidence available on request",
    "Greater confidence for banks, investors and boards",
  ];
  return (
