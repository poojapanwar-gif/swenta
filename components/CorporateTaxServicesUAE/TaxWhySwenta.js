...
const TaxWhySwenta = () => {
  const allList = [
    "Filings submitted accurately and on schedule",
    "A clear audit trail behind every position taken",
    "Lower risk of penalties from late or incorrect returns",
    "Better forecasting of tax cash outflows",
    "Access to advice before decisions are made, not after",
  ];
  return (
