...
import keybenefitimage from "../../public/images/keybenefitimage.jpg";
import Image from "next/image";
const AmlWhySwenta = () => {
  const allList = [
    "A framework proportionate to your actual risk profile",
    "Documented evidence available when regulators or partners ask",
    "Clear responsibilities for onboarding, monitoring and escalation",
    "Reduced exposure to compliance failures and business disruption",
    "Practical training that staff can apply in real situations",
  ];
  return (
      ...
      <div className={styles["why-swenta-left-right-section"]}>
        <div className={styles["why-swenta-left-section"]}>
          <div className={styles["left-image"]}>
            <Image src={keybenefitimage} alt="img" />
          </div>
        </div>
        <div className={styles["why-swenta-right-section"]}>
          <h6>Key benefits</h6>
          <h3>What your business gains</h3>
          ...
          <h4>Why choose Swenta</h4>
          <p>
            Swenta's UAE team is made up of experienced Chartered Accountants
            who work to a standard of accuracy, compliance and timely delivery.
            We tailor each engagement to the business in front of us — startups,
            SMEs and enterprises alike — and combine local regulatory
            understanding with international experience.
          </p>
        </div>
      </div>
    </div>
