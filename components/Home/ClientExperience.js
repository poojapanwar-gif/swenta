...
const ClientExperience = () => {
  const allList = [
    "Startups that need a finance function without a full-time hire",
    "SMEs replacing part-time or ad-hoc bookkeeping support",
    "Groups consolidating multiple UAE entities or free zone branches",
    "International companies establishing UAE operations",
  ];
  const allservicelist = [
    "Books that fall behind and are reconstructed under pressure before filing deadlines",
    "Financial reports that arrive too late to influence business decisions",
    "Inconsistent treatment of transactions across entities or branches",
    "In-house finance costs that rise faster than transaction volumes",
    "Audit and tax queries that take weeks to answer because records are incomplete",
  ];
  return (
