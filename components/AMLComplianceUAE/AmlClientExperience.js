...
const AmlClientExperience = () => {
  const allList = [
    ...
    "Financial services and payment businesses",
    "Real estate, precious metals and high-value dealers",
    "Compliance officers who need independent review and support",
  ];
  const allservicelist = [
    "Policies that exist on paper but are not applied consistently in practice",
    "Customer due diligence records that are incomplete or out of date",
    "Uncertainty about when and how to escalate and report suspicious activity",
    "Staff who have not received role-relevant AML training",
    "No documented evidence of ongoing monitoring or periodic review",
  ];
  return (
    <div className={styles["audit-experience-section"]}>
      <div className={styles["audit-experience-left-right-section"]}>
        <div className={styles["audit-experience-left-section"]}>
          ...
          <h2>What AML Compliance support from Swenta covers</h2>
          <p>
            Designated non-financial businesses and other regulated entities in
            the UAE carry ongoing AML obligations that go well beyond a written
            policy. Swenta helps you design a proportionate framework, embed it
            in day-to-day operations and keep the documentation regulators
            expect to see.
          </p>
