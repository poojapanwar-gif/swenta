...
const AuditClientExperience = () => {
  const allList = [
    "Companies preparing for their first statutory audit in the UAE",
    "Groups with multiple entities and consolidation requirements",
    "Businesses needing internal audit capability without a permanent team",
    "Boards and owners seeking independent assurance over controls",
  ];
  const allservicelist = [
    "Audit requests that consume weeks of internal management time",
    "Supporting schedules and reconciliations prepared from scratch each year",
    "Recurring audit observations that are never fully closed out",
    "Weak or undocumented internal controls across key processes",
    "Group reporting deadlines that are difficult to meet",
  ];
  return (
    <div className={styles["audit-experience-section"]}>
      <div className={styles["audit-experience-left-right-section"]}>
        <div className={styles["audit-experience-left-section"]}>
          ...
          <h2>What Audit support from Swenta covers</h2>
          <p>
            Audit pressure is usually a symptom of weak records and unclear
            controls, not of the audit itself. Swenta supports businesses
            through audit readiness, internal audit and controls review so the
            process is predictable, well documented and free of last-minute
            surprises.
          </p>
...
export default AuditClientExperience;
