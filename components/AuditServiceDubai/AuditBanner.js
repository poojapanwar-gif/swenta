    ...
    <div className={styles["banner-section"]}>
      <div className={styles["banner-left-right-section"]}>
        <div className={styles["banner-left-section"]}>
          <h6>— AUDIT SERVICE IN DUBAI</h6>
          <h2>Audit support that strengthens business confidence</h2>
          <h4>
            Improve transparency, financial controls and stakeholder confidence with dependable audit and assurance support.
          </h4>
          <p>
            <svg
              width="12"
            ...
            Internal audit · Assurance · Controls review
          </p>
