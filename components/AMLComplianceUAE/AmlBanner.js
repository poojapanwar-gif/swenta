    ...
    <div className={styles["banner-section"]}>
      <div className={styles["banner-left-right-section"]}>
        <div className={styles["banner-left-section"]}>
          <h6>— AML COMPLIANCE SERVICES UAE</h6>
          <h2>Build stronger AML compliance for your UAE business</h2>
          <h4>
            Identify gaps, strengthen your framework and manage regulatory risk with practical AML compliance support.
          </h4>
          <p>
            <svg
              width="12"
            ...
             Risk assessment · Policies · Compliance reviews
          </p>
