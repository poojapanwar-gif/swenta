...
import styles from "../../styles/ClientExperience.module.scss";
const AuditClientExperience = () => {
  return (
    <div className={styles["client-experience-section"]}>
      <div className={styles["client-experience-left-right-section"]}>
        <div className={styles["client-experience-left-section"]}>
          <h6>—CLIENT EXPERIENCE</h6>
          <h2>
            “Swenta’s customised approach built on our team’s strengths, making
            effective use of all resources and time.”
          </h2>
          <p>Insurance company · UAE</p>
        </div>
        <div className={styles["client-experience-right-section"]}>
          <div className={styles["right-content"]}>
            <h5>
              Looking for a finance partner who understands your business?
            </h5>
            <button>
